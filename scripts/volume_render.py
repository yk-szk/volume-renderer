...
def main():
    ...
    parser.add_argument('--no_gpu', '-ng', action='store_false', help='disable to use GPU')
    ...
    proj = volume_render(args.volume, args.preset, centered=args.no_centered, gpu=args.no_gpu,
